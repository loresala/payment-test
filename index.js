...
const { Item } = require("@adyen/api-library/lib/src/typings/checkout/item");
...
app.post('/notifications', function (req, res){
  try {
    ...
    console.log("Notification request item below");
    console.log(notificationRequestItems);

    notificationRequestItems.forEach(item => {
      if (validator.validateHMAC(item.NotificationRequestItem, process.env.HMAC_KEY)) {
        ...
        if (eventCode === 'AUTHORISED') {
          ...
          console.log(" Non valid notification request");
